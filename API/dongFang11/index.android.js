...
class WelcomeUI extends Component {
  ...
  render() {
    ...
    //let animationsAreEnabled=this.state.animationsAreEnabled;
    ...
    return (
        <View style={styles.container}>
          ...
          >
            {/* onPageScroll这里没bind(this),上面用箭头函数能避免bind(this) */}
            {pages}
          </ViewPagerAndroid>
...
//导航注册
const dongFang11 = StackNavigator({
  Home: {
    screen: WelcomeUI,
    navigationOptions: {
      header: null
...
AppRegistry.registerComponent('dongFang11', () => dongFang11);
