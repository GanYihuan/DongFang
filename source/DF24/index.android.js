...
class dongFang24 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      images: []
  ...
  render() {
    return (
        <ScrollView>
          ...
          <View>
            <Text
                onPress={this.saveImg.bind(this, 'dongfangyao888.jpg', 'reactnative.png')}
...
AppRegistry.registerComponent('dongFang24', () => dongFang24);
